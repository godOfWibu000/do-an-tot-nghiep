        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('assets/img/partner/partner_avatar.png') }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Auth::user()->email }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{ asset('assets/img/partner/partner_avatar.png') }}" class="img-circle" alt="User Image">
                <p>
                  {{ Auth::user()->email }}
                </p>
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ route('partner.tai-khoan.index') }}" class="btn btn-primary btn-flat" onclick=""><i class="fas fa-user"></i> Tài khoản</a>
                </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="{{ route('partner.thong-tin-doi-tac.index') }}">
            <i class="fas fa-user-tie"></i> <span>Thông tin đối tác</span></i>
          </a>
        </li>
        <li class="treeview">
          <a href="{{ route('partner.quan-ly-cho-o.index') }}">
            <i class="fas fa-hotel"></i> <span>Chỗ ở</span></i>
          </a>
        </li>
        <li class="treeview">
          <a href="{{ route('partner.quan-ly-dat-phong.index') }}">
            <i class="fas fa-scroll"></i> <span>Đặt phòng</span></i>
          </a>
        </li>
        <li class="treeview">
          <a href="{{ route('partner.thong-ke.index') }}">
            <i class="fas fa-chart-line"></i> <span>Thống kê đặt phòng</span></i>
          </a>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('partner.thong-tin-doi-tac.index') }}">Đối tác</a></li>
        @yield('redirect')
      </ol>
    </section>
